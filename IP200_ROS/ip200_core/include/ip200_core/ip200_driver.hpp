...
#define PI 3.141592
#define WHELL_DIAMETER 0.1305
#define WHELL_WITH 0.4
...
namespace aidl
{
	...
	public:
		...
		void odom_compute(const ros::TimerEvent &e)
		{
			...
			delta_x_ = (1)*(cur_vx_ * cos(th_) - cur_vy_ * sin(th_)) * delta_t_;
			delta_y_ = (cur_vx_ * sin(th_) + cur_vy_ * cos(th_)) * delta_t_;
			// delta_th_ = (1.1312)*cur_vth_ * delta_t_;
			// delta_th_ = (1.1313164)*cur_vth_ * delta_t_;
			delta_th_ = (1.13131)*cur_vth_ * delta_t_;
